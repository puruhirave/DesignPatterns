...
The Printer processes Print request with different events like PrintRequest, PrintStarted, PrintComplete events. The State transition for all Print events is OPERATION itself.
